...
//here a is aplus (which we must compute explicitly at the beginning of the simulation) and c is the current oxygen level, "oxigen"

#define Second_division_threshold(x,c)  aminus*pow((c/c_cr(x))-1,-beta)
//here x is p6_over_p3 and c is the current oxygen level, "oxigen"
//NOTES: we should check carefully the confusing use of oxigen vs oxygen when declaring variables
//and get a consistent notation across the code (06/09/2016). YET TO BE DONE
