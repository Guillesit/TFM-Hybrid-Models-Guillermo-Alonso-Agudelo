...
//Book_vector
void Book_Vector(double **pn, long S){
...
double Logistic(double time, double init,double alpha, double m_0){
...
double Compute_aplus(double p6_over_p3){
    ...
    //Taken from Roberto, subject to future changes   I HOPE NOT!!
    n_eqs=5;
    ...
    constants[1]=(0.0085*S*exp(2.5))/(k7*E*S*S); //kap2 for zero oxygen
    ...
    delta_t=0.001; //This should be more than enough.
