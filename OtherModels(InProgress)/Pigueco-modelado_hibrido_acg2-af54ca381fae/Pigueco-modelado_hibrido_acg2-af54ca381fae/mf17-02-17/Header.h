//header for the mean field code
...
#define MEMORY_BATCH 5000 //number of extra memory locations that will be requested in a memory extension round
...
//here x is p6_over_p3 and c is the current oxygen leve
